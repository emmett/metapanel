        ...
        readonly allOf: readonly [{
            ...
            readonly properties: {
                readonly strict: {
                    ...
                    readonly minimum: 0;
                    readonly maximum: 1;
                    readonly description: "If present and equal to 1, Mixpanel will validate the provided records and return a JSON object with per-record error messages for records that fail validation.";
                    readonly $schema: "http://json-schema.org/draft-04/schema#";
                };
                readonly verbose: {
                    readonly type: "integer";
        ...
        readonly allOf: readonly [{
            ...
            readonly properties: {
                readonly "Content-Type": {
                    ...
                    readonly description: "Default: application/json";
                    readonly $schema: "http://json-schema.org/draft-04/schema#";
                };
    ...
    readonly response: {
                ...
                readonly failed_records: {
                    ...
                    readonly items: {
                        ...
                        readonly properties: {
                            ...
                            readonly message: {
                                readonly type: "string";
                                readonly examples: readonly ["'properties.time' is invalid: must be specified as seconds since epoch"];
                            };
                        };
                    };
                };
        ...
        readonly "429": {
            ...
            readonly properties: {
                ...
                readonly error: {
                    readonly type: "string";
                    readonly examples: readonly ["Project exceeded rate limits. Please retry the request with exponential backoff."];
                };
                readonly status: {
                    readonly type: "string";
        ...
        readonly allOf: readonly [{
            ...
            readonly properties: {
                readonly id: {
                    ...
                    readonly format: "uuid";
                    readonly $schema: "http://json-schema.org/draft-04/schema#";
                    readonly description: "The ID of the lookup table to replace which can be retreived from Lexicon under the lookup table's details, click [here](https://docs.mixpanel.com/docs/data-structure/lookup-tables#where-can-i-find-the-id-of-the-lookup-table-for-apis-path-params) for more info.";
                };
            };
            ...
            readonly properties: {
                readonly "Content-Type": {
                    ...
                    readonly description: "Default: text/csv";
                    readonly $schema: "http://json-schema.org/draft-04/schema#";
                };
            };
            readonly required: readonly [];
    ...
    readonly response: {
        ...
        readonly "404": {
            ...
            readonly properties: {
                ...
                readonly error: {
                    readonly type: "string";
                    readonly examples: readonly ["Lookup table with id 'f077cb07-008a-4955-8a4a-b4c163db3a87' was not found."];
                };
                readonly status: {
                    readonly type: "string";
...
export { DeleteGroup, DeleteProfile, GroupBatchUpdate, GroupDeleteProperty, GroupRemoveFromListProperty, GroupSetProperty, GroupSetPropertyOnce, GroupUnion, ImportEvents, ListLookupTables, ProfileAppendToListProperty, ProfileBatchUpdate, ProfileDeleteProperty, ProfileNumericalAdd, ProfileRemoveFromListProperty, ProfileSet, ProfileSetPropertyOnce, ReplaceLookupTable, TrackEvent, UserProfileUnion };
